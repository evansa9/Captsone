...
?>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyAoV9Vzr7VoCKJnten4qEn_sKNegtepDNw">
    </script>

    <div id="map"></div>
    <script>
	    //added latitude and longitude session calls
        ...
        function saveData(lat,lng) {
            ...
            downloadUrl(url, function(data, responseCode) {
                if (responseCode === 200  && data.length > 1) {
                    ...
                    infowindow.close();
                    infowindow.setContent("<div style=' color: purple; font-size: 25px;'> Sent to friend</div>");
