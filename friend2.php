...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=<?php
include_once 'header.php';
include_once 'locations_model.php';
?>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyAoV9Vzr7VoCKJnten4qEn_sKNegtepDNw&callback=initMap">
